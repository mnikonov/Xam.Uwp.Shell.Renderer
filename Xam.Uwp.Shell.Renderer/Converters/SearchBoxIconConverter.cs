namespace Xam.Uwp.Shell.Renderer.Converters
{
    ...
    internal class SearchBoxIconConverter : IValueConverter
    {
        #region Fields
        ...
        public object Convert(object value, Type targetType, object parameter, string language)
        {
            switch (value)
            {
                ...
                case FontImageSource fontImageSource:
                    ...
                    {
                        icon.SetBinding(FontIcon.ForegroundProperty, "Color", this.colorToBrushConverter);
                    }
